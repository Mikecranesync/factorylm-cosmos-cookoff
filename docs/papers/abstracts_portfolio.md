...
**Primary Evidence:** `cookoff/diagnosis_engine.py`, `cookoff/WHITEPAPER.md`
...
**Primary Evidence:** `diagnosis/conveyor_faults.py`, `cookoff/WHITEPAPER.md` (Section 6.5)
...
**Primary Evidence:** `cookoff/MATRIX_WHITEPAPER.md`, `cookoff/diagnosis_engine.py`
...
**Primary Evidence:** `cookoff/MATRIX_WHITEPAPER.md`, `services/matrix/app.py`
...
**Primary Evidence:** `docs/CONVEYOR_OF_DESTINY.md` (Section 7), `cookoff/WHITEPAPER.md`
